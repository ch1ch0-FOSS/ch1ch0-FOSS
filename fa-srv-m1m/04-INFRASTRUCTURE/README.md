...
# srv-m1m-asahi: Production Linux Infrastructure

Professional infrastructure on Fedora Asahi (Apple Silicon M1)
...
00-BOOTSTRAP/ → System installation
01-FORGEJO/ → Git platform
02-VAULTWARDEN/ → Password manager
03-SYNCTHING/ → File sync
04-INFRASTRUCTURE/ → System-wide architecture ← START HERE
05-DISASTER-RECOVERY/ → Backup & recovery

## Quick Links
- [System Architecture](04-INFRASTRUCTURE/architecture-overview.md)
- [Current Status](04-INFRASTRUCTURE/system-state.md)
- [FHS Guide](04-INFRASTRUCTURE/FHS-compliance-guide.md)
- [Troubleshooting](TROUBLESHOOTING.md)

[Continue with service overview, philosophy, etc.]
